...
on a.memberid = b.id
where a.flightid=".$currentFlightId;
    ...
    for ($i = 0;$i < count($arr);$i++ ){
        if ($i == 0)
        {
            ...
            else
            {
                ...
                //not date parameter
                $queryString .= " where a.".$arr[$i]."='".$_GET[$arr[$i]]."' and a.flightid=".$currentFlightId;
                }
            }
        }
        else
        {
            ...
            else
            {
                ...
                //not date parameter
                $queryString .= " and a.".$arr[$i]."='".$_GET[$arr[$i]]."' and a.flightid=".$currentFlightId;
                }
            }
        }
